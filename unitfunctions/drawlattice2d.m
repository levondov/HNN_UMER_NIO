function h = drawlattice2d(ring,Offset, Scaling, hAxes, Ldraw)
...
%
%
% Levon: Need to run umerlat_main first before running this
%

% added by levon to display text above bpm
at2umer_bpm = {'IC2','RC1','RC2','RC3','RC5','RC6','RC7','RC8','RC9','RC11','RC12','RC13','RC14','RC15','RC17'};
...
for i = 1:length(THERING)
    ...
    if isfield(THERING{i},'BendingAngle') || any(strcmpi(THERING{i}.FamName,{'BEND','Kicker','dipole'})) 
    ...
    if any(strcmpi(THERING{i}.FamName,{'COR','XCOR','YCOR','HCOR','VCOR','VCM','HCM'})) || isfield(THERING{i},'KickAngle')
        % Corrector
        NumberOfFinds = NumberOfFinds + 1;
