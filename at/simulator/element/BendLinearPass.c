...
{	
	...
	/* Changed by Jinhyuk Choi, checked by Xiaobiao Huang
       The MAD physics manual shows 
       T534 = T543 = -1/4 K1 Sy2   (when K2=0). 
       Since M34*M43 = K1 Sy2 and z (r[5]) in AT has an opposite sign to MAD, in AT we should have
       R[5] += -(T534 + T543) y ypr = 1/2 K1 Sy2 = M34*M43*y*ypr/2;
    
    r[5]+= M34*M43*x*xpr/2;	was the old method */
	r[5]+= M34*M43*y*ypr/2;
}
