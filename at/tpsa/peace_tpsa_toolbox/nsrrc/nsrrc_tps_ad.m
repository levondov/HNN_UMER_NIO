function AD = nsrrc_tps_ad
% AD = nsrrc_ad_tps
% Return the Accelerator Data of NSRRC/TPS
%-------------------------------------------------------------------------------
...
AD.e_particle       = -1; % electron
AD.p_particle       = 1; % electron
% Machine Parameters
AD.bending_angle    = AD.pi/9.0; % bending angle of NSRRC/TLS storage bending magnets
AD.particle         = AD.e_particle; % electron
AD.Machine          = 'NSRRC_TPS';
AD.ATModel          = 'nsrrc2007';
AD.MCF              = 0.0063; % NSRRC
AD.InjEnergy        = 3.0;
AD.Energy           = 3.0; % (GeV) NSRRC
...
AD.ID.SW6.Parameter = [0 350]; % Current
AD.ID.SW6.PeakField = [0 3.5];
AD.ID.SW6.NumberOfPoles = 66;
AD.ID.SW6.NumberOfEndPoles = 2;
AD.ID.SW6.Mode = 0;
AD.ID.SW6.Type = 'AGID';
