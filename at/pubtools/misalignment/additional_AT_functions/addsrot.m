...
for i = 1:numelems
   ...
   if isfield(THERING{elemindex(i)}, 'BendingAngle') && isfield(THERING{elemindex(i)}, 'EntranceAngle')
       PolynomB(1) = PolynomB(1) + THERING{elemindex(i)}.BendingAngle/THERING{elemindex(i)}.Length;
   end
   ...
   if isfield(THERING{elemindex(i)}, 'BendingAngle') && isfield(THERING{elemindex(i)}, 'EntranceAngle')
       THERING{elemindex(i)}.PolynomB(1) = THERING{elemindex(i)}.PolynomB(1) - THERING{elemindex(i)}.BendingAngle/THERING{elemindex(i)}.Length;
   end
end